...
import user_interface_dao.EmployeInterface;
import javax.swing.*;
import java.awt.*;
...
public class LoginFrame extends JFrame {
    ...
    private void seconnecter() {
        ...
        try {
            ...
            if (employe != null) {
                JOptionPane.showMessageDialog(this,
                    "Connexion réussie !\nBienvenue " + employe.getNom() + " " + employe.getPrenom() +
                    "\nPrivilège : " + employe.getPrivilege(),
                    "Connexion réussie",
                    JOptionPane.INFORMATION_MESSAGE);

                
                new MenuFrame(employe.getPrivilege()).setVisible(true);

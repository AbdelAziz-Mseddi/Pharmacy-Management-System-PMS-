...
CREATE TABLE Commande(
    ...
    dateLivraisonReelle DATE, /*elle est remplie qu'à la réception*/
    CONSTRAINT dates_convenables CHECK(dateCommande < dateLivraisonPrevue),
    total FLOAT NOT NULL,
    CONSTRAINT valid_tot2 CHECK (total > 0),
    etat VARCHAR(10),
    CONSTRAINT valid_etat CHECK (etat in ('recue', 'annulee', 'en cours')) 
);
CREATE TABLE Medicament(
    ...
    CONSTRAINT valid_p2 CHECK(prixUnitaire > 0),
